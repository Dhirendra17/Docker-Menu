...
while True:
    ...
    if int(ch) == 1:
    #Pull image
        impImage = input("Please Enter the image name : ")
    ...
    #Run the image
        chImage = input("Please enter image name : ")
        chCUSImage = input("Please Custome name to image : ")
        chYN = input("After stoping the container do you want to remove container Y/N")
        if chYN == y or Y:
